...
#define AI_NETWORK_MODEL_SIGNATURE     "cb0a426d6c02bf5f2814b8c38fddf827"
...
AI_STATIC ai_array conv2d_8_bias_array;   /* Array #7 */
AI_STATIC ai_array conv2d_8_weights_array;   /* Array #8 */
AI_STATIC ai_array conv2d_7_bias_array;   /* Array #9 */
AI_STATIC ai_array conv2d_7_weights_array;   /* Array #10 */
AI_STATIC ai_array conv2d_6_bias_array;   /* Array #11 */
AI_STATIC ai_array conv2d_6_weights_array;   /* Array #12 */
...
AI_STATIC ai_array conv2d_5_output_array;   /* Array #16 */
AI_STATIC ai_array conv2d_6_output_array;   /* Array #17 */
AI_STATIC ai_array conv2d_7_output_array;   /* Array #18 */
AI_STATIC ai_array conv2d_8_output_array;   /* Array #19 */
AI_STATIC ai_array dense_4_output_array;   /* Array #20 */
AI_STATIC ai_array dense_4_nl_output_array;   /* Array #21 */
AI_STATIC ai_array dense_5_output_array;   /* Array #22 */
AI_STATIC ai_array dense_5_nl_output_array;   /* Array #23 */
AI_STATIC ai_array dense_6_output_array;   /* Array #24 */
AI_STATIC ai_array dense_6_nl_output_array;   /* Array #25 */
...
AI_STATIC ai_tensor conv2d_8_bias;   /* Tensor #7 */
AI_STATIC ai_tensor conv2d_8_weights;   /* Tensor #8 */
AI_STATIC ai_tensor conv2d_7_bias;   /* Tensor #9 */
AI_STATIC ai_tensor conv2d_7_weights;   /* Tensor #10 */
AI_STATIC ai_tensor conv2d_6_bias;   /* Tensor #11 */
AI_STATIC ai_tensor conv2d_6_weights;   /* Tensor #12 */
...
AI_STATIC ai_tensor conv2d_5_output;   /* Tensor #16 */
AI_STATIC ai_tensor conv2d_6_output;   /* Tensor #17 */
AI_STATIC ai_tensor conv2d_7_output;   /* Tensor #18 */
AI_STATIC ai_tensor conv2d_8_output;   /* Tensor #19 */
AI_STATIC ai_tensor conv2d_8_output0;   /* Tensor #20 */
AI_STATIC ai_tensor dense_4_output;   /* Tensor #21 */
AI_STATIC ai_tensor dense_4_nl_output;   /* Tensor #22 */
AI_STATIC ai_tensor dense_5_output;   /* Tensor #23 */
AI_STATIC ai_tensor dense_5_nl_output;   /* Tensor #24 */
AI_STATIC ai_tensor dense_6_output;   /* Tensor #25 */
AI_STATIC ai_tensor dense_6_nl_output;   /* Tensor #26 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv2d_5_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv2d_6_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain conv2d_7_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain conv2d_8_chain;   /* Chain #3 */
AI_STATIC_CONST ai_tensor_chain dense_4_chain;   /* Chain #4 */
AI_STATIC_CONST ai_tensor_chain dense_4_nl_chain;   /* Chain #5 */
AI_STATIC_CONST ai_tensor_chain dense_5_chain;   /* Chain #6 */
AI_STATIC_CONST ai_tensor_chain dense_5_nl_chain;   /* Chain #7 */
AI_STATIC_CONST ai_tensor_chain dense_6_chain;   /* Chain #8 */
AI_STATIC_CONST ai_tensor_chain dense_6_nl_chain;   /* Chain #9 */
...
AI_STATIC ai_layer_conv2d conv2d_5_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d conv2d_6_layer; /* Layer #1 */
AI_STATIC ai_layer_conv2d conv2d_7_layer; /* Layer #2 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_8_layer; /* Layer #3 */
AI_STATIC ai_layer_dense dense_4_layer; /* Layer #4 */
AI_STATIC ai_layer_nl dense_4_nl_layer; /* Layer #5 */
AI_STATIC ai_layer_dense dense_5_layer; /* Layer #6 */
AI_STATIC ai_layer_nl dense_5_nl_layer; /* Layer #7 */
AI_STATIC ai_layer_dense dense_6_layer; /* Layer #8 */
AI_STATIC ai_layer_nl dense_6_nl_layer; /* Layer #9 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 128, 13, 2), AI_STRIDE_INIT(4, 4, 4, 512, 6656),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 64, 3, 1, 1), AI_STRIDE_INIT(4, 4, 256, 768, 768),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 64, 3, 3, 128), AI_STRIDE_INIT(4, 4, 256, 768, 2304),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 1, 13, 9), AI_STRIDE_INIT(4, 4, 4, 4, 52),
  1, &input_0_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_5_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 13, 9), AI_STRIDE_INIT(4, 4, 4, 64, 832),
  1, &conv2d_5_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_6_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 13, 9), AI_STRIDE_INIT(4, 4, 4, 128, 1664),
  1, &conv2d_6_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_7_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 64, 13, 9), AI_STRIDE_INIT(4, 4, 4, 256, 3328),
  1, &conv2d_7_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_8_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 128, 6, 4), AI_STRIDE_INIT(4, 4, 4, 512, 3072),
  1, &conv2d_8_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_8_output0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 3072, 1, 1), AI_STRIDE_INIT(4, 4, 4, 12288, 12288),
  1, &conv2d_8_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_ENTRY(&conv2d_8_output0),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_6_nl_output),
  &conv2d_5_layer, 0, NULL)
