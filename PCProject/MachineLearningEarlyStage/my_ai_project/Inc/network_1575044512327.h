...
#ifndef __AI_NETWORK_1575044512327_H__
#define __AI_NETWORK_1575044512327_H__
#pragma once

#include "ai_platform.h"

#define AI_NETWORK_1575044512327_MODEL_NAME          "network_1575044512327"

#define AI_NETWORK_1575044512327_IN_NUM       (1)
#define AI_NETWORK_1575044512327_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 90, 3, 1, 1, NULL), \
}
#define AI_NETWORK_1575044512327_IN_SIZE { \
  (90 * 3 * 1), \
}
#define AI_NETWORK_1575044512327_IN_1_SIZE  (90 * 3 * 1)
#define AI_NETWORK_1575044512327_IN_1_SIZE_BYTES  ((90 * 3 * 1) * 4)


#define AI_NETWORK_1575044512327_OUT_NUM      (1)
#define AI_NETWORK_1575044512327_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_NETWORK_1575044512327_OUT_SIZE { \
  (1 * 1 * 6), \
}
#define AI_NETWORK_1575044512327_OUT_1_SIZE  (1 * 1 * 6)
#define AI_NETWORK_1575044512327_OUT_1_SIZE_BYTES  ((1 * 1 * 6) * 4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1575044512327
 ...
 * @ref ai_network_1575044512327_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1575044512327_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_1575044512327_*
 * defines into file @ref network_1575044512327.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1575044512327_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_NETWORK_1575044512327_H__*/
